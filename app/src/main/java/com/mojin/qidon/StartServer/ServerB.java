...
public class ServerB extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!StartGame.isAccessibilitySettingsOn(this, AccessibilitySampleService.class.getName())) {// 判断服务是否开启
            ...
            new Thread(new Runnable(){
                    ...
                    public void run() {
                        while (true) {
                            if (StartGame.isAccessibilitySettingsOn(ServerB.this, AccessibilitySampleService.class.getName())) {
                                ShortCutStartGame.Start(ServerB.this, "5000");
                                break;
                            }
                        }
                    }
            ...
            ShortCutStartGame.Start(this, "5000");
        }
    }
